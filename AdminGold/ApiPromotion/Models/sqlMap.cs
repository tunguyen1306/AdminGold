...
this IDbConnection cnn, string sql, Func<TFirst, TSecond, TThird, TFourth, TReturn> map, object param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = null
        ...
        internal static Func<IDataReader, object> GetDictionaryDeserializer(IDataRecord reader, int startBound, int length, bool returnNullIfFirstMissing)
        {
            ...
            // look for ? / @ / : *by itself*
            static readonly Regex smellsLikeOleDb = new System.Text.RegularExpressions.Regex(@"(?<![a-z0-9@_])[?@:](?![a-z0-9@_])", RegexOptions.IgnoreCase | RegexOptions.Multiline | RegexOptions.CultureInvariant | RegexOptions.Compiled),
...
#pragma warning restore 612, 618
        ...
        sealed class DataTableHandler : ApiPromotion.Models.SqlMapper.ITypeHandler
        {
        ...
        /// Used to pass a DataTable as a TableValuedParameter
        /// </summary>
        sealed partial class TableValuedParameter : ApiPromotion.Models.SqlMapper.ICustomQueryParameter
        {
        ...
        /// </summary>
        sealed partial class DbString : ApiPromotion.Models.SqlMapper.ICustomQueryParameter
        {
            /// <summary>
