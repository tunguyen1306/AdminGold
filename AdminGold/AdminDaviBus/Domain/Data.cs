...
namespace AdminDaviBus.Domain
{
    public class Data
    {
        public IEnumerable<Navbar> navbarItems()
        {
            ...
            menu.Add(new Navbar { Id =7, nameOption = "Danh sách chi tiết trạm", controller = "ChiTietTram", action = "Index", status = true, isParent = false, parentId = 2 });
            menu.Add(new Navbar { Id =7, nameOption = "Danh sách xe", controller = "DmXe", action = "Index", status = true, isParent = false, parentId = 2 });
